...
import com.xunevermore.nodeadapter.BaseNodeItem;
import com.xunevermore.nodeadapter.INodeItem;
import com.xunevermore.nodeadapter.ViewHolder;
 ...
 */
public class ProvinceBean extends BaseNodeItem {
    /**
    ...
    public void bindData(ViewHolder viewHolder) {
        viewHolder.setText(R.id.tv_name, provinceName);
    ...
    public static class CityBean extends BaseNodeItem {
        /**
        ...
        @Override
        public int getItemLayoutRes() {
            return R.layout.item_clean_level_1;
        }

        @Override
        public void bindData(ViewHolder viewHolder) {
            viewHolder.setText(R.id.tv_name, cityName);
        ...
        @Override
        public void init() {
            super.getChildNodes().addAll(areas);
            for (INodeItem childNode : getChildNodes()) {
                if (childNode == null) {
                    continue;
                }
        ...
        public static class AreasBean extends BaseNodeItem {
            /**
             * areaId : 2799
             * areaName : 三环以内
             */
            ...
            @Override
            public int getItemLayoutRes() {
                return R.layout.item_clean_level_2;
            }

            @Override
            public void bindData(ViewHolder viewHolder) {
                viewHolder.setText(R.id.tv_name, areaName);
